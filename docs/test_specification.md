...
| テストID | 要求ID | テスト内容 | 入力/条件 | 期待結果 | 対象テスト |
|---|---|---|---|---|---|
| <a id="test-unit-093"></a>TEST-UNIT-093 | REQ-SIM-002 | 開始フレーム | progress=0 | 最初の較正点を返す  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_frame_is_first_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_frame_is_first_point]] |
| <a id="test-unit-094"></a>TEST-UNIT-094 | REQ-SIM-002 | 終了フレーム | progress=1 | 最終較正点を返す  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_end_frame_is_last_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_end_frame_is_last_point]] |
| <a id="test-unit-095"></a>TEST-UNIT-095 | REQ-SIM-002 | 中間フレーム | 0<progress<1 | 走査順に対応した点を返す  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_middle_progress_maps_to_scan_order]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_middle_progress_maps_to_scan_order]] |
| <a id="test-unit-096"></a>TEST-UNIT-096 | REQ-SIM-002 | 保持時間非反映 | 異なるhold_timeで同plan点数 | 約10秒再生構成が保持時間に依存しない  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_playback_duration_is_independent_of_hold_time]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_playback_duration_is_independent_of_hold_time]] |
| <a id="test-unit-097"></a>TEST-UNIT-097 | REQ-SIM-003 | 横面図初期化 | valid plan | pitch/X/Yを表現する描画要素生成  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_side_view_is_initialized]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_side_view_is_initialized]] |
| <a id="test-unit-098"></a>TEST-UNIT-098 | REQ-SIM-003 | 正面図初期化 | valid plan | rollを表現する描画要素生成  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_front_view_is_initialized]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_front_view_is_initialized]] |
| <a id="test-unit-099"></a>TEST-UNIT-099 | REQ-SIM-004 | 情報表示 | 任意点 | point番号、AoA/AoS、X/Y/Z/A、状態、進捗を更新  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_render_frame_updates_required_information]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_render_frame_updates_required_information]] |
| <a id="test-unit-122"></a>TEST-UNIT-122 | REQ-SIM-005 | 較正点マップ初期化 | 複数較正点を持つvalid plan | AoS横軸、AoA縦軸で全較正点を表示し、凡例を表示しない  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_calibration_map_displays_all_points_without_legend]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_calibration_map_displays_all_points_without_legend]] |
| <a id="test-unit-123"></a>TEST-UNIT-123 | REQ-SIM-006 | 現在較正点の強調・同期 | 異なる2点を連続描画 | 現在点だけが通常点と異なる色で表示され、横面図・正面図と同じ点へ同期更新され、文字注記を追加しない  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_current_calibration_point_color_tracks_rendered_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_current_calibration_point_color_tracks_rendered_point]] |
| <a id="test-unit-126"></a>TEST-UNIT-126 | REQ-SIM-007 | シミュレーション開始状態 | 有効なplanで開始 | 先頭較正点から再生を開始し、再生中状態と一時停止ボタン「Ⅱ」を表示する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_sets_playing_state_at_first_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_sets_playing_state_at_first_point]] |
| <a id="test-unit-127"></a>TEST-UNIT-127 | REQ-SIM-008 | 一時停止 | 再生中に一時停止操作 | タイマーが停止し、現在較正点を保持し、再生ボタン「▶」を表示する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_pause_stops_animation_and_keeps_current_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_pause_stops_animation_and_keeps_current_point]] |
| <a id="test-unit-128"></a>TEST-UNIT-128 | REQ-SIM-009 | 一時停止からの再生再開 | 中間点で一時停止後に再生 | 現在位置から再生を再開する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_resume_restarts_from_current_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_resume_restarts_from_current_point]] |
| <a id="test-unit-129"></a>TEST-UNIT-129 | REQ-SIM-010 | 一時停止中の較正点シーク | 一時停止中に指定点へ移動 | 指定した較正点を現在点として保持する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_while_paused_selects_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_while_paused_selects_point]] |
| <a id="test-unit-130"></a>TEST-UNIT-130 | REQ-SIM-011 | 再生中シーク時の自動一時停止 | 再生中にシーク操作開始 | 自動一時停止し、操作終了後も再生ボタン「▶」を表示する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_while_playing_pauses_automatically]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_while_playing_pauses_automatically]] |
| <a id="test-unit-131"></a>TEST-UNIT-131 | REQ-SIM-012 | シーク表示即時反映 | 指定点へシーク | 横面図・正面図・マップ・数値・進捗表示が同一の指定点へ更新される  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_renders_selected_point_immediately]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_renders_selected_point_immediately]] |
| <a id="test-unit-132"></a>TEST-UNIT-132 | REQ-SIM-013 | 再生完了 | 最終フレーム到達 | 最終較正点で停止し、自動ループせず、再生ボタン「▶」を表示する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_animation_completion_stays_at_last_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_animation_completion_stays_at_last_point]] |
| <a id="test-unit-133"></a>TEST-UNIT-133 | REQ-SIM-009 | 完了後の再生 | 完了後に再生操作 | 先頭較正点へ戻って再生を開始する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_resume_after_completion_restarts_at_first_point]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_resume_after_completion_restarts_at_first_point]] |
| <a id="test-unit-134"></a>TEST-UNIT-134 | REQ-SIM-014, REQ-SIM-015 | シークバー設定 | 複数較正点のplanを初期化 | 既存プログレスバーを表示せず、較正点インデックス単位で操作でき、大きなつまみを持つ  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_view_has_point_based_seek_bar_with_large_handle]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_view_has_point_based_seek_bar_with_large_handle]] |
| <a id="test-unit-135"></a>TEST-UNIT-135 | REQ-SIM-016 | 再生状態とボタン表示 | 再生中/停止中/完了後 | 再生中は「Ⅱ」、停止中および完了後は「▶」を表示する  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_playback_button_label_follows_state]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_playback_button_label_follows_state]] |
| <a id="test-unit-136"></a>TEST-UNIT-136 | REQ-SIM-014 | 進捗表示 | 任意の現在点 | 表示が「現在の較正点 / 全較正点」となり、時間表示を使用しない  | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_progress_text_uses_point_count_not_time]] | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_progress_text_uses_point_count_not_time]] |
...
| 要求ID | 単体テストID |
|---|---|---|
| REQ-INPUT-001 | TEST-UNIT-002,003,004,005 | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_aoa_min_equal_max]] |
| REQ-INPUT-002 | TEST-UNIT-006,007,008 | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_aoa_points_minimum_valid]] |
| REQ-INPUT-003 | TEST-UNIT-011,111,112 | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_distance_non_finite]] |
| REQ-INPUT-004 | TEST-UNIT-009,010,070,071,113,114,115,116 | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_feed_rate_invalid]] |
| REQ-INPUT-005 | TEST-UNIT-012,013,014,015 | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_x_range_equal]] |
| REQ-INPUT-006 | TEST-UNIT-067,080,081,106 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_initialization_text_preserved_in_order]] |
| REQ-INPUT-007 | TEST-UNIT-072,073 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_comments_enabled]] |
| REQ-VALID-001 | TEST-UNIT-001,016,084,085,086,101,102 | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_valid_settings]] |
| REQ-VALID-002 | TEST-UNIT-001..016,111..116（該当入力検証） | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_valid_settings]] |
| REQ-VALID-003 | TEST-UNIT-047,054,055,056,057,087,088 | [[TESTCODE_SHORT:tests.test_limits.TestLimitEvaluator.test_all_axes_in_range]] |
| REQ-TRANS-001 | TEST-UNIT-025,026..032 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_origin_transform]] |
| REQ-TRANS-002 | TEST-UNIT-025..032,040,060 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_origin_transform]] |
| REQ-TRANS-003 | TEST-UNIT-036,037,038,039,040 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_in_range_candidate_has_priority]] |
| REQ-TRANS-004 | TEST-UNIT-033,034,035,064 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_unwrap_plus_360]] |
| REQ-POS-001 | TEST-UNIT-041,042,043,044,045,060,065 | [[TESTCODE_SHORT:tests.test_positioning.TestPositionCompensator.test_zero_pitch_requires_no_translation]] |
| REQ-POS-002 | <a id="test-unit-046"></a>TEST-UNIT-046 | [[TESTCODE_SHORT:tests.test_positioning.TestPositionCompensator.test_roll_does_not_affect_xy]] |
| REQ-LIMIT-001 | TEST-UNIT-047,048,049,050,051,058,059,063,065,075,087,125 | [[TESTCODE_SHORT:tests.test_limits.TestLimitEvaluator.test_all_axes_in_range]] |
| REQ-LIMIT-002 | TEST-UNIT-052,053,061,063,103 | [[TESTCODE_SHORT:tests.test_limits.TestLimitEvaluator.test_x_deviation]] |
| REQ-LIMIT-003 | TEST-UNIT-054,055,056,057,059,062,088,092,104,125 | [[TESTCODE_SHORT:tests.test_limits.TestLimitEvaluator.test_z_above_max_not_clamped]] |
| REQ-SCAN-001 | TEST-UNIT-017,018,019,023,024,060,084 | [[TESTCODE_SHORT:tests.test_scan.TestScanPlanner.test_minimum_grid_has_four_endpoints]] |
| REQ-SCAN-002 | TEST-UNIT-020,024,064 | [[TESTCODE_SHORT:tests.test_scan.TestScanPlanner.test_basic_scan_aoa_outer_aos_inner]] |
| REQ-SCAN-003 | TEST-UNIT-021,022,064 | [[TESTCODE_SHORT:tests.test_scan.TestScanPlanner.test_serpentine_second_row_reversed]] |
| REQ-GCODE-001 | TEST-UNIT-082,083,110 | [[TESTCODE_SHORT:tests.test_repositories.TestRepositories.test_save_nc_file]] |
| REQ-GCODE-002 | TEST-UNIT-066,067 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_header_contains_required_commands]] |
| REQ-GCODE-003 | TEST-UNIT-068,069,070,071,075 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_each_move_has_four_axes_and_feed]] |
| REQ-GCODE-004 | TEST-UNIT-072,073 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_comments_enabled]] |
| REQ-GCODE-005 | <a id="test-unit-074"></a>TEST-UNIT-074 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_no_return_home_after_final_point]] |
| REQ-SIM-001 | <a id="test-unit-109"></a>TEST-UNIT-109 | [[TESTCODE_SHORT:tests.test_gui.TestMainWindow.test_simulation_uses_current_plan]] |
| REQ-SIM-002 | TEST-UNIT-093,094,095,096 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_frame_is_first_point]] |
| REQ-SIM-003 | TEST-UNIT-097,098 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_side_view_is_initialized]] |
| REQ-SIM-004 | <a id="test-unit-099"></a>TEST-UNIT-099 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_render_frame_updates_required_information]] |
| REQ-SIM-005 | <a id="test-unit-122"></a>TEST-UNIT-122 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_calibration_map_displays_all_points_without_legend]] |
| REQ-SIM-006 | <a id="test-unit-123"></a>TEST-UNIT-123 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_current_calibration_point_color_tracks_rendered_point]] |
| REQ-SIM-007 | <a id="test-unit-126"></a>TEST-UNIT-126 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_sets_playing_state_at_first_point]] |
| REQ-SIM-008 | <a id="test-unit-127"></a>TEST-UNIT-127 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_pause_stops_animation_and_keeps_current_point]] |
| REQ-SIM-009 | TEST-UNIT-128,133 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_resume_restarts_from_current_point]] |
| REQ-SIM-010 | <a id="test-unit-129"></a>TEST-UNIT-129 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_while_paused_selects_point]] |
| REQ-SIM-011 | <a id="test-unit-130"></a>TEST-UNIT-130 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_while_playing_pauses_automatically]] |
| REQ-SIM-012 | <a id="test-unit-131"></a>TEST-UNIT-131 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_seek_renders_selected_point_immediately]] |
| REQ-SIM-013 | <a id="test-unit-132"></a>TEST-UNIT-132 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_animation_completion_stays_at_last_point]] |
| REQ-SIM-014 | TEST-UNIT-134,136 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_view_has_point_based_seek_bar_with_large_handle]] |
| REQ-SIM-015 | <a id="test-unit-134"></a>TEST-UNIT-134 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_view_has_point_based_seek_bar_with_large_handle]] |
| REQ-SIM-016 | <a id="test-unit-135"></a>TEST-UNIT-135 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_playback_button_label_follows_state]] |
| REQ-GUI-001 | TEST-UNIT-100,124 | [[TESTCODE_SHORT:tests.test_gui.TestMainWindow.test_required_japanese_labels_and_buttons_are_defined]] |
| REQ-GUI-002 | TEST-UNIT-090,091,092,125 | [[TESTCODE_SHORT:tests.test_map_view.TestCalibrationMapView.test_axes_are_aos_horizontal_aoa_vertical]] |
| REQ-GUI-003 | TEST-UNIT-076,077,078,079,089,107,108,117,118,119,120,121 | [[TESTCODE_SHORT:tests.test_repositories.TestRepositories.test_settings_csv_round_trip]] |
| REQ-GUI-004 | TEST-UNIT-100,107,108,109,110 | [[TESTCODE_SHORT:tests.test_gui.TestMainWindow.test_required_japanese_labels_and_buttons_are_defined]] |
| REQ-GUI-005 | TEST-UNIT-101,102,103,104,105,121 | [[TESTCODE_SHORT:tests.test_gui.TestMainWindow.test_validation_error_changes_target_background_and_shows_existing_message]] |
...
| モジュール/メソッド | テストID |
|---|---|---|
| `InputValidator.validate` | TEST-UNIT-001..016,111..116 | [[TESTCODE_SHORT:tests.test_validation.TestInputValidator.test_valid_settings]] |
| `ScanPlanner.generate_points` | TEST-UNIT-017..024 | [[TESTCODE_SHORT:tests.test_scan.TestScanPlanner.test_minimum_grid_has_four_endpoints]] |
| `AngleTransformer.transform` | TEST-UNIT-025..032,040 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_origin_transform]] |
| `AngleTransformer._unwrap_angle` | TEST-UNIT-033..035 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_unwrap_plus_360]] |
| `AngleTransformer._select_solution` | TEST-UNIT-036..039 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_in_range_candidate_has_priority]] |
| `AngleTransformer._generate_equivalent_solutions` | <a id="test-unit-040"></a>TEST-UNIT-040 | [[TESTCODE_SHORT:tests.test_transform.TestAngleTransformer.test_equivalent_solution_candidates_are_generated]] |
| `PositionCompensator.calculate_xy` | TEST-UNIT-041..046 | [[TESTCODE_SHORT:tests.test_positioning.TestPositionCompensator.test_zero_pitch_requires_no_translation]] |
| `LimitEvaluator.evaluate` | TEST-UNIT-047..059 | [[TESTCODE_SHORT:tests.test_limits.TestLimitEvaluator.test_all_axes_in_range]] |
| `CalibrationService.build_plan` | TEST-UNIT-060..065 | [[TESTCODE_SHORT:tests.test_calibration_service.TestCalibrationService.test_build_plan_creates_evaluation_for_every_point]] |
| `GCodeGenerator._format_header` | TEST-UNIT-066,067 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_header_contains_required_commands]] |
| `GCodeGenerator._format_point` | TEST-UNIT-068..073,075 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_each_move_has_four_axes_and_feed]] |
| `GCodeGenerator.generate` | TEST-UNIT-066..075 | [[TESTCODE_SHORT:tests.test_gcode.TestGCodeGenerator.test_header_contains_required_commands]] |
| `SettingsRepository.save/load` | TEST-UNIT-076..079,117..120 | [[TESTCODE_SHORT:tests.test_repositories.TestRepositories.test_settings_csv_round_trip]] |
| `InitializationGCodeRepository.load` | TEST-UNIT-080,081 | [[TESTCODE_SHORT:tests.test_repositories.TestRepositories.test_initialization_gcode_utf8_multiline]] |
| `GCodeRepository.save` | TEST-UNIT-082,083 | [[TESTCODE_SHORT:tests.test_repositories.TestRepositories.test_save_nc_file]] |
| `CalibrationController.on_settings_changed/apply_settings/can_generate` | TEST-UNIT-084..089 | [[TESTCODE_SHORT:tests.test_controller.TestCalibrationController.test_valid_input_rebuilds_plan]] |
| `CalibrationMapView.render` | TEST-UNIT-090..092,125 | [[TESTCODE_SHORT:tests.test_map_view.TestCalibrationMapView.test_axes_are_aos_horizontal_aoa_vertical]] |
| `CalibrationMapView._configure_matplotlib_font/_text` | <a id="test-unit-124"></a>TEST-UNIT-124 | [[TESTCODE_SHORT:tests.test_map_view.TestCalibrationMapView.test_japanese_font_selection_and_english_fallback]] |
| `SimulationController.start/_frame_at` | TEST-UNIT-093..096,126 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_frame_is_first_point]] |
| `SimulationController.pause/resume/seek_to_point/restart_from_beginning/on_animation_complete` | TEST-UNIT-127..133 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_pause_stops_animation_and_keeps_current_point]] |
| `SimulationView.initialize/render_frame` | TEST-UNIT-097..099,122,123,131,136 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_side_view_is_initialized]] |
| `SimulationView.start_animation/set_playback_state/_on_seek/_on_play_pause/_update_seek_bar/_update_playback_button` | TEST-UNIT-126..136 | [[TESTCODE_SHORT:tests.test_simulation.TestSimulation.test_start_sets_playing_state_at_first_point]] |
| `MainWindow` | TEST-UNIT-100..110,121 | [[TESTCODE_SHORT:tests.test_gui.TestMainWindow.test_required_japanese_labels_and_buttons_are_defined]] |
...
|---|---|---|---|
| UC-01 | 較正条件を入力・更新する | TEST-UC-01-01 ～ TEST-UC-01-12 | [[TESTCODE_SHORT:tests.test_use_cases.TestUseCases.test_uc01_valid_input_recalculates_plan]] |
| UC-02 | 初期化Gコードを読み込む | TEST-UC-02-01 ～ TEST-UC-02-04 | [[TESTCODE_SHORT:tests.test_use_cases.TestUseCases.test_uc02_load_initialization_text]] |
| UC-03 | 設定を保存する | TEST-UC-03-01 ～ TEST-UC-03-04 | [[TESTCODE_SHORT:tests.test_use_cases.TestUseCases.test_uc03_save_all_settings_to_csv]] |
| UC-04 | 設定を読み込む | TEST-UC-04-01 ～ TEST-UC-04-11 | [[TESTCODE_SHORT:tests.test_use_cases.TestUseCases.test_uc04_load_valid_csv_and_rebuild_plan]] |
| UC-05 | シミュレーションする | TEST-UC-05-01 ～ TEST-UC-05-16 | [[TESTCODE_SHORT:tests.test_use_cases.TestUseCases.test_uc05_normal_simulation_uses_full_plan]] |
| UC-06 | Gコードを生成する | TEST-UC-06-01 ～ TEST-UC-06-12 | [[TESTCODE_SHORT:tests.test_use_cases.TestUseCases.test_uc06_generate_valid_nc]] |
