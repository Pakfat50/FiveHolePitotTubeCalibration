...
class TestInputValidator(unittest.TestCase):
    ...
    def test_valid_settings(self):
        ...
        Test:
            TEST-UNIT-001: 全入力が仕様範囲内の場合、検証結果が有効でエラーを含まないこと。
        Details:
    ...
    def test_aoa_min_greater_than_max(self):
        ...
        Test:
            TEST-UNIT-003: aoa_min > aoa_max は不正入力であること。
        Details:
    ...
    def test_aos_min_equal_max(self):
        ...
        Test:
            TEST-UNIT-004: aos_min == aos_max は不正入力であること。
        Details:
    ...
    def test_aos_min_greater_than_max(self):
        ...
        Test:
            TEST-UNIT-005: aos_min > aos_max は不正入力であること。
        Details:
    ...
    def test_aoa_points_minimum_valid(self):
        ...
        Test:
            TEST-UNIT-006: aoa_points=2 は有効であること。
        Details:
            許容下限値を入力し、検証が成功することを確認する。
        Verification rationale:
            下限値そのものを試験することで、境界を1点ずらして誤判定する実装を検出できる。
        See Also:
            REQ-INPUT-002, REQ-VALID-002
        """
    ...
    def test_aoa_points_too_small(self):
        ...
        Test:
            TEST-UNIT-007: aoa_points=1 は不正であること。
        Details:
    ...
    def test_aos_points_too_small(self):
        ...
        Test:
            TEST-UNIT-008: aos_points=1 は不正であること。
        Details:
    ...
    def test_hold_time_invalid(self):
        ...
        Test:
            TEST-UNIT-010: 0.1秒未満、NaN、+Infの保持時間は無効であること。
        Details:
    ...
    def test_distance_non_finite(self):
        ...
        Test:
            TEST-UNIT-011: tip_offset_x/y にNaNまたはInfを指定した場合は無効であること。
        Details:
            X/Y両寸法についてNaNとInfを組み合わせて検証する。
        Verification rationale:
            両フィールドそれぞれで非有限値を直接入力するため、有限実数であるという仕様を確認できる。
        See Also:
            REQ-INPUT-003, REQ-VALID-002
        """
    ...
    def test_x_range_equal(self):
        ...
        Test:
            TEST-UNIT-012: X minimum == maximum は無効であること。
        Details:
    ...
    def test_y_range_reversed(self):
        ...
        Test:
            TEST-UNIT-013: Y minimum > maximum は無効であること。
        Details:
    ...
    def test_z_range_invalid(self):
        ...
        Test:
            TEST-UNIT-014: Z minimum >= maximum は無効であること。
        Details:
            Z軸の最小・最大を同値にして検証する。
        Verification rationale:
    ...
    def test_a_range_invalid(self):
        ...
        Test:
            TEST-UNIT-015: A minimum > maximum は無効であること。
        Details:
            A軸だけを逆転させ、検証結果を確認する。
        Verification rationale:
    ...
    def test_multiple_errors_are_reported(self):
        ...
        Test:
            TEST-UNIT-016: 複数フィールドが不正な場合、単一エラーで打ち切らず複数issueを返すこと。
        Details:
    ...
    def test_lx_zero_is_invalid(self):
        ...
        Test:
            TEST-UNIT-111: Lxは0より大きくなければならない。
        Details:
    ...
    def test_hold_time_minimum_is_valid(self):
        ...
        Test:
            TEST-UNIT-113: hold_time_s=0.1 は許容下限として有効であること。
        Details:
    ...
    def test_hold_time_below_minimum_is_invalid(self):
        ...
        Test:
            TEST-UNIT-114: hold_time_s<0.1 は無効であること。
        Details:
    ...
    def test_feed_rate_minimum_is_valid(self):
        ...
        Test:
            TEST-UNIT-115: feed_rate=1.0 は有効であること。
        Details:
            許容下限値を入力して検証成功を確認する。
        Verification rationale:
    ...
    def test_feed_rate_below_minimum_is_invalid(self):
        ...
        Test:
            TEST-UNIT-116: feed_rate<1.0 は無効であること。
        Details:
