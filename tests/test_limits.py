...
class TestLimitEvaluator(unittest.TestCase):
    ...
    def test_all_axes_in_range(self):
        ...
        TEST ID: TEST-UNIT-047: 正常指令ではx/y_saturated=Falseかつrotational_error=Falseであること。
        検証根拠:
        全軸0という明確な範囲内指令の評価結果を直接確認するため、正常系で誤警告・誤エラーがないことを判定できる。
        対応要求: REQ-LIMIT-001, REQ-VALID-003
        """
        r = self._eval()
    ...
    def test_x_above_max_saturates(self):
        ...
        TEST ID: TEST-UNIT-048: X=1200に対し指令値1000、x_saturated=Trueとなること。
        検証根拠:
    ...
    def test_x_below_min_saturates(self):
        ...
        TEST ID: TEST-UNIT-049: X=-1200に対し指令値-1000となること。
        検証根拠:
    ...
    def test_y_above_max_saturates(self):
        ...
        TEST ID: TEST-UNIT-050: Y=1200に対し指令値1000となること。
        検証根拠:
    ...
    def test_y_below_min_saturates(self):
        ...
        TEST ID: TEST-UNIT-051: Y=-1200に対し指令値-1000となること。
        検証根拠:
    ...
    def test_x_deviation(self):
        ...
        TEST ID: TEST-UNIT-052: X=1200、上限1000ではx_deviation=200であること。
        検証根拠:
    ...
    def test_y_deviation(self):
        ...
        TEST ID: TEST-UNIT-053: Y=-1200、下限-1000ではy_deviation=200であること。
        検証根拠:
    ...
    def test_z_above_max_not_clamped(self):
        ...
        TEST ID: TEST-UNIT-054: Z=200を保持したままrotational_error=Trueとなること。
        検証根拠:
        出力Zが入力値のまま残ることとエラーフラグを同時確認するため、回転軸を飽和させない仕様を直接検証できる。
        対応要求: REQ-LIMIT-003, REQ-VALID-003
        """
    ...
    def test_z_below_min_not_clamped(self):
        ...
        TEST ID: TEST-UNIT-055: Z=-200を保持したままrotational_error=Trueとなること。
        検証根拠:
    ...
    def test_a_above_max_not_clamped(self):
        ...
        TEST ID: TEST-UNIT-056: A=800を保持したままrotational_error=Trueとなること。
        検証根拠:
    ...
    def test_a_below_min_not_clamped(self):
        ...
        TEST ID: TEST-UNIT-057: A=-800を保持したままrotational_error=Trueとなること。
        検証根拠:
    ...
    def test_xy_only_overrange_is_not_generation_error(self):
        ...
        TEST ID: TEST-UNIT-058: X/Y飽和が同時発生してもrotational_error=Falseであること。
        検証根拠:
        並進軸2軸を同時に範囲外へし、飽和フラグと回転エラーなしを確認することで、警告と生成禁止の分類を直接検証できる。
        対応要求: REQ-LIMIT-001, REQ-LIMIT-003
        """
    ...
    def test_translation_and_rotation_overrange_combined(self):
        ...
        TEST ID: TEST-UNIT-059: Xは1000へ飽和し、Zは200のまま保持され、回転エラーになること。
        検証根拠:
