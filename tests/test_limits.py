...
class TestLimitEvaluator(unittest.TestCase):
    ...
    def test_all_axes_in_range(self):
        ...
        パスクライテリア:
            正常指令ではx/y_saturated=Falseかつrotational_error=Falseであること。
    ...
    def test_x_above_max_saturates(self):
        ...
        パスクライテリア:
            X=1200に対し指令値1000、x_saturated=Trueとなること。
    ...
    def test_x_deviation(self):
        ...
        パスクライテリア:
            X=1200、上限1000ではx_deviation=200であること。
    ...
    def test_y_deviation(self):
        ...
        パスクライテリア:
            Y=-1200、下限-1000ではy_deviation=200であること。
    ...
    def test_z_above_max_not_clamped(self):
        ...
        パスクライテリア:
            Z=200を保持したままrotational_error=Trueとなること。
    ...
    def test_a_above_max_not_clamped(self):
        ...
        パスクライテリア:
            A=800を保持したままrotational_error=Trueとなること。
    ...
    def test_xy_only_overrange_is_not_generation_error(self):
        ...
        パスクライテリア:
            X/Y飽和が同時発生してもrotational_error=Falseであること。
    ...
    def test_translation_and_rotation_overrange_combined(self):
        ...
        パスクライテリア:
            Xは1000へ飽和し、Zは200のまま保持され、回転エラーになること。
