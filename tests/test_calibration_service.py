...
class TestCalibrationService(unittest.TestCase):
    ...
    def test_plan_aggregates_max_xy_deviation(self):
        ...
        TEST ID: TEST-UNIT-061: max_x_deviation/max_y_deviationがPointEvaluation群の最大偏差を保持すること。
    ...
    def test_any_rotational_error_blocks_generation(self):
        ...
        TEST ID: TEST-UNIT-062: 狭いZ範囲でrotational_errorが発生し、has_generation_error=Trueとなること。
    ...
    def test_xy_saturation_alone_does_not_block_generation(self):
        ...
        TEST ID: TEST-UNIT-063: X/Y飽和点が存在してもhas_generation_error=Falseであること。
