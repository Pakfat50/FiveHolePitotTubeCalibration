...
class TestRepositories(unittest.TestCase):
    ...
    def test_settings_csv_round_trip(self):
        ...
        Test:
            TEST-UNIT-076: SettingsRepository.save/load の往復後に元のCalibrationSettingsと一致すること。
    ...
    def test_options_round_trip(self):
        ...
        Test:
            TEST-UNIT-077: serpentine/output_commentsの4組合せが保存前後で一致すること。
        Verification rationale:
    ...
    def test_axis_ranges_round_trip(self):
        ...
        Test:
            TEST-UNIT-078: loaded.axis_limitsが保存前axis_limitsと一致すること。
        Verification rationale:
    ...
    def test_structurally_invalid_csv_returns_explicit_error(self):
        ...
        Test:
            TEST-UNIT-079: key/value形式でないCSV読込が明示的な設定読込エラーになること。
        Verification rationale:
    ...
    def test_initialization_gcode_utf8_multiline(self):
        ...
        Test:
            TEST-UNIT-080: ファイル内容とload()戻り値が完全一致すること。
        Verification rationale:
    ...
    def test_missing_initialization_file_raises_ioerror(self):
        ...
        Test:
            TEST-UNIT-081: missing pathに対するload()がOSErrorを送出すること。
        Verification rationale:
    ...
    def test_save_nc_file(self):
        ...
        Test:
            TEST-UNIT-082: save後の実ファイル内容が入力テキストと一致すること。
        Verification rationale:
    ...
    def test_gcode_save_failure_is_reported(self):
        ...
        Test:
            TEST-UNIT-083: 存在しないディレクトリへのsaveがOSErrorを送出すること。
        Verification rationale:
    ...
    def test_missing_required_csv_key(self):
        ...
        Test:
            TEST-UNIT-117: feed_rateキー欠損でSettingsLoadErrorとなること。
        Verification rationale:
    ...
    def test_blank_required_csv_value(self):
        ...
        Test:
            TEST-UNIT-118: feed_rate=""でSettingsLoadErrorとなること。
        Verification rationale:
    ...
    def test_non_numeric_csv_value(self):
        ...
        Test:
            TEST-UNIT-119: feed_rate="abc"でSettingsLoadErrorとなること。
        Verification rationale:
    ...
    def test_settings_io_failure_is_wrapped(self):
        ...
        Test:
            TEST-UNIT-120: 存在しない設定CSV読込でSettingsLoadErrorとなること。
        Verification rationale:
