...
class TestAngleTransformer(unittest.TestCase):
    ...
    def test_origin_transform(self):
        ...
        TEST ID: TEST-UNIT-025: 中立姿勢の変換結果が原点であること。
        検証根拠:
    ...
    def test_positive_aoa_zero_aos(self):
        ...
        TEST ID: TEST-UNIT-026: AoA=10,AoS=0に対しZ=10,A=0となること。
        検証根拠:
    ...
    def test_negative_aoa_zero_aos_reproduces_input(self):
        ...
        TEST ID: TEST-UNIT-027: AoA=-10,AoS=0の出力は有限値で、逆変換すると入力角を再現すること。
        検証根拠:
    ...
    def test_zero_aoa_positive_aos(self):
        ...
        TEST ID: TEST-UNIT-028: AoA=0,AoS=10の変換結果を逆評価すると入力角に一致すること。
        検証根拠:
    ...
    def test_general_solution_matches_formula(self):
        ...
        TEST ID: TEST-UNIT-029: AoA=12,AoS=7でZ=atan(hypot(tanAoA,tanAoS)), A=atan2(v,u)となること。
        検証根拠:
    ...
    def test_quadrant_ii(self):
        ...
        TEST ID: TEST-UNIT-030: AoA=-10,AoS=10で90<A<=180となること。
        検証根拠:
    ...
    def test_quadrant_iii(self):
        ...
        TEST ID: TEST-UNIT-031: AoA=-10,AoS=-10で-180..-90または等価な180..270に入ること。
        検証根拠:
    ...
    def test_quadrant_iv(self):
        ...
        TEST ID: TEST-UNIT-032: AoA=10,AoS=-10で-90<A<0または等価な270<A<360となること。
        検証根拠:
    ...
    def test_unwrap_plus_360(self):
        ...
        TEST ID: TEST-UNIT-033: _unwrap_angle(-179,179)=181となること。
        検証根拠:
    ...
    def test_unwrap_minus_360(self):
        ...
        TEST ID: TEST-UNIT-034: _unwrap_angle(179,-179)=-181となること。
        検証根拠:
    ...
    def test_unwrap_avoids_358_degree_jump(self):
        ...
        TEST ID: TEST-UNIT-035: 前回179度から次値-179度は2度以内の変化として扱われること。
        検証根拠:
    ...
    def test_in_range_candidate_has_priority(self):
        ...
        TEST ID: TEST-UNIT-036: Z=20候補とZ=200候補では範囲内のZ=20を選ぶこと。
        検証根拠:
    ...
    def test_continuity_has_priority(self):
        ...
        TEST ID: TEST-UNIT-037: previous=(10,5)では(10,10)を(10,170)より優先すること。
        検証根拠:
    ...
    def test_smaller_total_motion_selected(self):
        ...
        TEST ID: TEST-UNIT-038: previous=(10,10)に対し(20,20)を(30,30)より選ぶこと。
        検証根拠:
    ...
    def test_smaller_absolute_roll_breaks_tie(self):
        ...
        TEST ID: TEST-UNIT-039: 等価な±20度ロール候補から|A|=20の候補を選ぶこと。
        検証根拠:
    ...
    def test_equivalent_solution_candidates_are_generated(self):
        ...
        TEST ID: TEST-UNIT-040: (20,30)から生成した候補が空でなく基本解(20,30)を含むこと。
        検証根拠:
        解選択の入力となる候補集合を直接観測し、最低限基本解が失われないことを確認するため、等価解生成処理の成立を検証できる。
        対応要求: REQ-TRANS-002, REQ-TRANS-003
        """
