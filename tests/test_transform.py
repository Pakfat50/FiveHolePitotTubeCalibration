...
class TestAngleTransformer(unittest.TestCase):
    ...
    def test_origin_transform(self):
        ...
        Test:
            TEST-UNIT-025: 中立姿勢の変換結果が原点であること。
    ...
    def test_positive_aoa_zero_aos(self):
        ...
        Test:
            TEST-UNIT-026: AoA=10,AoS=0に対しZ=10,A=0となること。
        Verification rationale:
    ...
    def test_negative_aoa_zero_aos_reproduces_input(self):
        ...
        Test:
            TEST-UNIT-027: AoA=-10,AoS=0の出力は有限値で、逆変換すると入力角を再現すること。
        Verification rationale:
    ...
    def test_zero_aoa_positive_aos(self):
        ...
        Test:
            TEST-UNIT-028: AoA=0,AoS=10の変換結果を逆評価すると入力角に一致すること。
        Verification rationale:
    ...
    def test_general_solution_matches_formula(self):
        ...
        Test:
            TEST-UNIT-029: AoA=12,AoS=7でZ=atan(hypot(tanAoA,tanAoS)), A=atan2(v,u)となること。
        Verification rationale:
    ...
    def test_quadrant_ii(self):
        ...
        Test:
            TEST-UNIT-030: AoA=-10,AoS=10で90<A<=180となること。
        Verification rationale:
    ...
    def test_quadrant_iii(self):
        ...
        Test:
            TEST-UNIT-031: AoA=-10,AoS=-10で-180..-90または等価な180..270に入ること。
        Verification rationale:
    ...
    def test_quadrant_iv(self):
        ...
        Test:
            TEST-UNIT-032: AoA=10,AoS=-10で-90<A<0または等価な270<A<360となること。
        Verification rationale:
    ...
    def test_unwrap_plus_360(self):
        ...
        Test:
            TEST-UNIT-033: _unwrap_angle(-179,179)=181となること。
        Verification rationale:
    ...
    def test_unwrap_minus_360(self):
        ...
        Test:
            TEST-UNIT-034: _unwrap_angle(179,-179)=-181となること。
        Verification rationale:
    ...
    def test_unwrap_avoids_358_degree_jump(self):
        ...
        Test:
            TEST-UNIT-035: 前回179度から次値-179度は2度以内の変化として扱われること。
        Verification rationale:
    ...
    def test_in_range_candidate_has_priority(self):
        ...
        Test:
            TEST-UNIT-036: Z=20候補とZ=200候補では範囲内のZ=20を選ぶこと。
        Verification rationale:
    ...
    def test_continuity_has_priority(self):
        ...
        Test:
            TEST-UNIT-037: previous=(10,5)では(10,10)を(10,170)より優先すること。
        Verification rationale:
    ...
    def test_smaller_total_motion_selected(self):
        ...
        Test:
            TEST-UNIT-038: previous=(10,10)に対し(20,20)を(30,30)より選ぶこと。
        Verification rationale:
    ...
    def test_smaller_absolute_roll_breaks_tie(self):
        ...
        Test:
            TEST-UNIT-039: 等価な±20度ロール候補から|A|=20の候補を選ぶこと。
        Verification rationale:
    ...
    def test_equivalent_solution_candidates_are_generated(self):
        ...
        Test:
            TEST-UNIT-040: (20,30)から生成した候補が空でなく基本解(20,30)を含むこと。
        Verification rationale:
